...
from GrootMusic import Telegram, YouTube, app
from GrootMusic.misc import SUDOERS
from GrootMusic.plugins.play.playlist import del_plist_msg
from GrootMusic.plugins.sudo.sudoers import sudoers_list
...
from GrootMusic.utils.decorators.language import LanguageStart
from GrootMusic.utils.inline import help_pannel, private_panel, start_pannel
from GrootMusic.utils.command import commandpro
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f""" ❥❥━─────➸➽♦️❥❥━─────➸➽\n\n😒 ᴡᴇʟᴄᴏᴍᴇ **{message.from_user.mention()} 👋**\n\n💠 ᴛʜɪs ɪs ᴛʜᴇ **[{BOT_NAME}](https://t.me/{BOT_USERNAME}),** \n\n💠 ᴀ ʙᴏᴛ ғᴏʀ ᴘʟᴀʏɪɴɢ ʜɪɢʜ ǫᴜᴀʟɪᴛʏ ᴀɴᴅ ᴜɴʙʀᴇᴀᴋᴀʙʟᴇ ᴍᴜsɪᴄ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘs ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.\n\n💠 ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ & ᴍᴀᴋᴇ ᴀs ᴀ ᴀᴅᴍɪɴ ᴡɪᴛʜ ɴᴇᴇᴅᴇᴅ ᴀᴅᴍɪɴ ᴘᴇʀᴍɪssɪᴏɴs ᴛᴏ ᴘᴇʀғᴏʀᴍ ᴀ ʀɪɢʜᴛ ᴀᴄᴛɪᴏɴs,ɴᴏᴡ ʟᴇᴛ's ᴇɴᴊᴏʏ ᴘᴀɴᴅᴀɢᴏᴏ ʏᴏᴜʀ ᴍᴜsɪᴄ!!\n\n❥❥━─────➸➽♦️❥❥━─────➸➽ """,
