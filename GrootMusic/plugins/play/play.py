...
from GrootMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from GrootMusic.core.call import Groot
from GrootMusic.utils import seconds_to_min, time_to_seconds
from GrootMusic.utils.channelplay import get_channeplayCB
from GrootMusic.utils.database import is_video_allowed
from GrootMusic.utils.decorators.language import languageCB
from GrootMusic.utils.decorators.play import PlayWrapper
from GrootMusic.utils.formatters import formats
from GrootMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from GrootMusic.utils.inline.playlist import botplaylist_markup
from GrootMusic.utils.logger import play_logs
from GrootMusic.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("GrootPlaylists") & ~BANNED_USERS)
@languageCB
