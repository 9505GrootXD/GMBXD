...
from GrootMusic.utils.database import get_authuser_names, get_cmode
from GrootMusic.utils.decorators import ActualAdminCB, AdminActual, language
from GrootMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Groot.stop_stream(message.chat.id)
    except:
        pass
