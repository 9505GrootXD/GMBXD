...
from GrootMusic.utils import Grootbin, get_channeplayCB, seconds_to_min
from GrootMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from GrootMusic.utils.decorators.language import language, languageCB
from GrootMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph//file/fcd8e32be453166a7825e.jpg",
        caption=_["queue_1"],
    )
