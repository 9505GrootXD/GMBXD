...
**ᴘᴏᴡʀᴇᴅ ʙʏ @RJbr0 , @Groot_Network , @TeluguFriendsClub"""
...
**groot** sᴛᴀɴᴅs ғᴏʀ ɢʀᴏᴏᴛ ʙᴏᴛ ᴘʟᴀʏ.
...
**<u>ɢʙᴀɴ ғᴇᴀᴛᴜʀᴇ:</u>**
/gban [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴄʜᴜᴛɪʏᴀ] : ɢʟᴏʙᴀʟʟʏ ʙᴀɴs ᴛʜᴇ ᴘᴜᴋ ɢᴀᴅᴜ ғʀᴏᴍ ᴀʟʟ ᴛʜᴇ sᴇʀᴠᴇᴅ ᴄʜᴀᴛs ᴀɴᴅ ʙʟᴀᴄᴋʟɪsᴛ ʜɪᴍ ғʀᴏᴍ ᴜsɪɴɢ ᴛʜᴇ ʙᴏᴛ.
...
/alive : ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴄᴋ ɢʀᴏᴏᴛ ᴍᴜsɪᴄ ʙᴏᴛ ɪs ᴀʟɪᴠᴇ ᴏʀ ɴᴏᴛ
